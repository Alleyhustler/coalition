...
document.addEventListener("DOMContentLoaded", function () {
  const text = `PROCESSING QUERY: Syndicate Intelligence—Strategic Nexus—Data Origin—Operational Protocol
  \nHYPOTHETICAL SCENARIO DETECTED: An intelligence anomaly generated by a neural breach in the Syndicate Intelligence network. This nexus reshapes strategic pathways and facilitates access to tailored outputs: business growth, industry dominance, or other calculated objectives.
`;
